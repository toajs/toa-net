...
class Socket extends EventEmitter {
  ...
  _initBufDecoder (socket) {
    socket.decoder = new Resp({bufBulk: true})
  ...
  _onHandshake (data, authenticate) {
    ...
    this.socket.decoder.on('data', this._onMessage.bind(this))
  }
  ...
  _encodeBuf (bufOrStr) {
    return Resp.encodeBulk(bufOrStr)
  }
